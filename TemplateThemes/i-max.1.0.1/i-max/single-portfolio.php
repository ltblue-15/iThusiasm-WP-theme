						...
						<?php                        
                            ...
                            if (class_exists('MultiPostThumbnails')) 
							{
								...
								if ($large_image_url1)
								{
									...
									MultiPostThumbnails::the_post_thumbnail( get_post_type(), 'feature-image-2', NULL, 'single-thumb' );
									echo '</a>';
								}
								...
								if ($large_image_url2)
								{
									...
									MultiPostThumbnails::the_post_thumbnail( get_post_type(), 'feature-image-3', NULL, 'single-thumb' );
									echo '</a>';
								}
                            } 							
                        ?>
