	 ...
	 function options_page() { ?>
        ...
        <div id="optionsframework-themepromo">
        	<div class="promo-inner">
                ...
                <div class="inside">
                    ...
                    <p>If you like i-max please rate us at <a href="<?php esc_attr_e( 'http://wordpress.org/support/view/theme-reviews/i-max', 'textdomain' ); ?>" target="_blank">WordPress.org</a> and like our <a href="<?php esc_attr_e( 'http://facebook.com/templatesnext/', 'textdomain' ); ?>" target="_blank">facebook page</a>. </p>
                </div>
            </div>
        </div>     
        ...
        <div class="promo-2">
        	<div class="promo-wrap">
            	<a href="<?php esc_attr_e( 'http://templatesnext.org/imax/', 'textdomain' ); ?>" target="_blank">i-max Demo</a>
                <a href="<?php esc_attr_e( 'http://templatesnext.org/imax/docs', 'textdomain' ); ?>">Documentation</a> 
                <div class="donate">                
